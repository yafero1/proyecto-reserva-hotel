		...
		<div class="grid-container py-2">
			...
			<div class="grid-item">
				...
				<a href="<?php echo $ruta;  ?>">
					...
					<img src="img/logoPortobello.png" class="img-fluid">
...
<nav class="menu container-fluid p-0">
	...
	<ul class="nav nav-justified py-2">
		...
		<li class="nav-item">
			<a class="nav-link text-white" href="#pueblo">La ciudad</a>
		</li>
...
<div class="menuMovil">
	...
	<ul class="nav flex-column mt-4 pl-4 mb-5">
		...
		<li class="nav-item">
			<a class="nav-link text-white my-2" href="#pueblo">Recorrido por la ciudad</a>
		</li>
