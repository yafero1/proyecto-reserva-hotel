					...
					<?php if ($validarPagoReserva): ?>
							  	...
							  	<div class="card-footer d-flex bg-white">
							 		...
							 		<form action="<?php echo $ruta.'perfil'; ?>" method="POST" class="pt-3">
									  <script
									    ...
									    data-public-key="TEST-e17cf850-63c6-46a8-b1ec-2e03f79ff4eb"
							...
							if(isset($_REQUEST["token"])){
								...
								$issuer_id = $_REQUEST["issuer_id"];
							  	...
							  	MercadoPago\SDK::setAccessToken("TEST-486813805921877-071703-fa34f936dbb1e7d6322cc372084c0189-10190478");
					...
					<?php
				     ...
				     if(!$reservas){
					     ...
					     echo '<p class="help-block small">
							...
							<a href="https://api.whatsapp.com/send?phone=573001112233&text=Hola Hotel Porto Bello, necesito hacer un cambio en una reserva" target="_blank">+57 300 111 22 33</a>
