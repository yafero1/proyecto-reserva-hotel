			...
			if(preg_match('/^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["registroNombre"]) &&
			   preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["registroEmail"]) &&
				...
				if($respuesta == "ok"){
					...
					$mail->setFrom('yafero1@gmail.com', 'Hotel Porta Bello');

					$mail->addReplyTo('yafero1@gmail.com', 'Hotel Porta Bello');
					...
					$mail->msgHTML('<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
							...
							<center>
								...
								<img style="padding:20px; width:10%" src="https://img.icons8.com/cotton/64/000000/add-folder--v1.png">
							...
							<div style="position:relative; margin:auto; width:600px; background:white; padding:20px">
								...
								<center>
									...
									<img style="padding:20px; width:15%" src="<img src="https://img.icons8.com/color/48/000000/gmail.png"/>">
